...
if __name__ == '__main__':
    algorithm_eval = AlgorithmEval(network_fp='../data/tmp/CJDLtest1.net.xml')
    algorithm_eval.connect('121.36.231.253', 1883)
    algorithm_eval.initialize()

    # 初始化Storage TODO: 应该放在内部
    algorithm_eval.sim.initialize_internal_storage(junction_list=('point93', 'point92', 'point98'))
